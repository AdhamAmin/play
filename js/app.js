...
// Initialize the application when all resources are loaded
window.addEventListener('load', () => {
    console.log('Window loaded. Checking dependencies...');
    console.log('Translations type:', typeof Translations);
    console.log('GameConfig type:', typeof GameConfig);

    // Check if Translations is available on window if not in scope
    if (typeof Translations === 'undefined' && window.Translations) {
        console.log('Restoring Translations from window object');
